...
<html lang="en">
  <head>
    ...
    <meta name="title" content="Blessing Fawole
" />
    <meta name="language" content="English" />

    <meta
      name="description"
      content="Blessing Fawole
 is a highly skilled FullStack Developer from Holberton with extensive experience in web development."
    />
    <meta
      name="copyright"
      content="© 2020 - 2024 Blessing Fawole
 - All Rights Reserved."
    />
    <meta name="author" content="Blessing Fawole
" />

    <meta property="og:title" content="Blessing Fawole
" />
    <meta property="og:site_name" content="Blessing Fawole
" />
    <meta property="og:url" content=https://bless643/.github.io/>
    <meta
      property="og:description"
      content="Blessing Fawole
 is a highly skilled FullStack Developer from Sri Lanka with extensive experience in web development."
    />
    <meta property="og:type" content="website" />
    <meta property="og:image" content="/img/photo-intro.webp" />

    <title>Blessing Fawole
</title>
    <link
  ...
  <body id="to-top" class="noselect">
    <nav class="navbar navbar-expand-lg fixed-top">
      <div class="container">
        <a class="nav-brand noselect" href="index.html">BF</a>
        ...
        <div class="collapse navbar-collapse collapse-bg" id="navbarNav">
          ...
          <a href="https://drive.google.com/file/d/17m4Q1lstvjvk78rFQ3sJlInoD12CA6x9/view?usp=sharing"
        ...
        <section id="intro">
          <div class="container" data-aos="fade-down" data-aos-duration="1000">
            <div class="text">
              <h1>
                Hi, I am<br />
                <span class="green my-name">Blessing,</span>
                <br />
              </h1>
              <div class="typing">
              ...
              <p>
                Welcome to my portfolio! My name is <span id="intro-p">Blessing Fawole
</span>, and I am a skilled
                <span id="intro-p">Full Stack Developer</span> with a profound passion for crafting web experiences that are both
                <span id="intro-p">visually stunning</span> and
                <span id="intro-p">intuitive</span>. Boasting a
                <span id="intro-p">unique</span> combination of technical expertise and creative flair, I am
                <span id="intro-p">confident</span> in my ability to deliver
                <span id="intro-p">custom solutions</span> that precisely address the diverse needs of my clients.
            </p>
              ...
              <div class="intro-btns">
                ...
                href="https://github.com/bless643"
                target="_blank"
                 >
            ...
            <div class="about-wrapper">
              ...
              <div class="right">
                <h2>
                  ...
                  <span class="green"> and Expertise</span>
              </h2>
              <p>
                  As a seasoned full-stack developer, my distinct strength lies in my adeptness at critical thinking and problem-solving. I excel in the art of dissecting intricate projects, breaking them into manageable components, and devising innovative solutions for any challenges that may arise. My organizational prowess and meticulous attention to detail ensure that assignments are not only completed promptly but also uphold the highest standards of quality.
              </p>
              <p>
                  Proficient in a diverse array of programming languages and frameworks, including HTML, CSS, JavaScript, and Python, my expertise extends to working with industry-leading technologies such as MongoDB, Express, React, and Node.js. I bring a refined skill set to UI/UX development and possess the agility to swiftly adapt to emerging technologies and frameworks. My knowledge extends beyond the mentioned technologies, reflecting a comprehensive understanding of the ever-evolving tech landscape.
              </p>
              <p>
                  Beyond technical proficiency, I am a strong communicator, fostering effective collaboration with clients and team members alike. This enables me to comprehend their needs and translate them into precise functional specifications. Overall, I am unwaveringly confident in my capacity to deliver web solutions of the highest caliber, meeting and surpassing the expectations of my clients.
              </p>
...
<div class="skill-cards-container">
    <div class="div-card">
        <div class="div-card-item english" title="Level: Proficient"></div>
        <span>English</span>
    </div>
</div>
            </div>
                ...
                <ul>
                  <li>
                    <div class="timeline-content">
                      ...
                      <h2 class="title education">Extended Diploma in Applied Sciences</h2>
                      <h3 class="sub-title school">Lambeth College - London</h3>
                      <p class="description">
                        
                          In 2017, I embarked on an enriching journey in Applied Science, earning an Extended Diploma at Lambeth College in London, which I completed in 2019. This rigorous program immersed me in the various scientific disciplines, providing a holistic education marked by academic excellence, as evidenced by my graduation with Distinction.
                      </p> 
                    </div>

                    <div class="timeline-content">
                      <h3 class="date">2023</h3>
                      <h2 class="title education">Software Engineering</h2>
                      <h3 class="sub-title school">ALX, Nairobi & Holberton - San Francisco</h3>
                      <p class="description">
                          In 2023, I pursued an immersive education in Software Engineering, a program that seamlessly blended the innovative curriculum of ALX in Nairobi with the renowned expertise of Holberton in San Francisco. This unique educational journey provided me with a comprehensive understanding of software engineering principles, best practices, and real-world applications. Through hands-on projects and collaboration with industry professionals, I honed my skills in creating robust and scalable software solutions. This educational experience has been pivotal in shaping my proficiency and passion for the field. For more details or inquiries, please don't hesitate to get in touch.
                      </p> 
                    </div>

                    <div class="timeline-content">
                       <b>City of Residence:</b> London
                       <br>
                       <b>Gender:</b> Female
                      </p>
                    </div>
...
/"
                      ...
                      <a
                        ...
                        href="https://stackoverflow.com/users/17067744/blessing-fawole"
                        class="social-icon"
                        target="_blank"
                      >
                      ...
                      <a
                        title="LinkedIn"
                        href="https://lk.linkedin.com/in/bless643
/"
                        class="social-icon"
                        target="_blank"
                      >
                      ...
                      <a
                        title="Twitter"
                        href="https://twitter.com/bless643
/"
                        class="social-icon"
                        target="_blank"
                      >
                      ...
                      <a
                        title="Facebook"
                        href="https://facebook.com/bless643
/.Dev"
                        class="social-icon"
                        target="_blank"
                      >
